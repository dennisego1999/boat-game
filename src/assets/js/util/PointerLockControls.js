...
class PointerLockControls extends EventDispatcher {
	constructor(camera, domElement) {
		...
		this.connect = function () {
			...
			scope.domElement.ownerDocument.addEventListener('mousedown', () => {
				this.press = true;
			});
			scope.domElement.ownerDocument.addEventListener('mouseup', () => {
				this.press = false;
			});
			scope.domElement.ownerDocument.addEventListener('mouseleave', () => {
				this.press = false;
			});
